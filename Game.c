...
Game *CreateGame(){
	...
	game->board[7][3] = CreatePiece(BLACK, KING);
	game->board[7][4] = CreatePiece(BLACK, QUEEN);
	...
	game->board[0][3] = CreatePiece(WHITE, KING);
	game->board[0][4] = CreatePiece(WHITE, QUEEN);
